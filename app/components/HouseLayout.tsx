  ...
  return (
    <div className="flex flex-col relative items-center">
      ...
      <div className="absolute top-0 left-0 w-full h-full">
        ...
        <Image src={balloonKitchen} className='w-full h-full animate-wiggle shadow-lg' alt="bollon-eiyou" style={{ position: 'absolute', top: '55%', left: '28%', width: '15%', height: '15%' }}/>
        </Link>
        {/* 寝室へのリンク */}
        <Link href="/?category=ベッド">
        <Image src={balloonBed} className='w-full h-full animate-wiggle shadow-lg' alt="bollon-bed" style={{ position: 'absolute', top: '28%', left: '58%', width: '15%', height: '15%' }}/>
        </Link>
        <Link href="/?category=歩行">
        <Image src={balloonLiving} className='w-full h-full animate-wiggle shadow-lg' alt="bollon-living" style={{ position: 'absolute', top: '55%', left: '58%', width: '15%', height: '15%' }}/>
        </Link>
      </div>
